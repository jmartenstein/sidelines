...
updated_at: 2026-02-07T02:11:17Z
parent: side-0mn
---
...
## Checklist
- [x] Import/Define color mapping logic in `src/score_over_time.py`
- [x] Look up colors for home and visitor teams in `plot_scores`
- [x] Implement default color fallback
- [x] Verify colors are correctly assigned to variables
